...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  void initState() {
    ...
    //   await player.setSource(AssetSource('audio/Badass.mp3'));
    //   await player.resume();
    // });
    player.setSource(AssetSource('audio/Badass.mp3'));
    super.initState();
  }
                        ...
                        child: InkWell(
                          onTap: () {
                            if (pause == false) {
                              ...
                              player.play(AssetSource("audio/Badass.mp3"));
                            } else {
                              setState(() {
                                pause = false;
                              });
                  ...
                  Column(
                    ...
                    children: [
                      Slider(
                        ...
                        thumbColor: Colors
                            .white, // Optional: Customize the thumb color.
                      ),
                      Row(
                        children: [
                          Padding(
